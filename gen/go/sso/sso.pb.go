...
type LoginRequest struct {
	...
	AccountIdentifier isLoginRequest_AccountIdentifier `protobuf_oneof:"account_identifier"`
	Password          string                           `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"`         // Password of the user to login
	AppId             int32                            `protobuf:"varint,4,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // App ID of the user to login to
}
...
func (m *LoginRequest) GetAccountIdentifier() isLoginRequest_AccountIdentifier {
	if m != nil {
...
func (x *LoginRequest) GetEmail() string {
	if x, ok := x.GetAccountIdentifier().(*LoginRequest_Email); ok {
		return x.Email
	}
	return ""
}
...
func (x *LoginRequest) GetUsername() string {
	if x, ok := x.GetAccountIdentifier().(*LoginRequest_Username); ok {
		return x.Username
	}
	return ""
}
...
type isLoginRequest_AccountIdentifier interface {
	isLoginRequest_AccountIdentifier()
}

type LoginRequest_Email struct {
	Email string `protobuf:"bytes,1,opt,name=email,proto3,oneof"` // Email of the user to login
}

type LoginRequest_Username struct {
	Username string `protobuf:"bytes,2,opt,name=username,proto3,oneof"` // Username of the user to login
}

func (*LoginRequest_Email) isLoginRequest_AccountIdentifier() {}

func (*LoginRequest_Username) isLoginRequest_AccountIdentifier() {}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token for the user
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User ID of the user to check if admin
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Whether the user is admin
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x64, 0x22, 0x8d, 0x01, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x42, 0x14, 0x0a,
	0x12, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66,
	0x69, 0x65, 0x72, 0x22, 0x25, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x29, 0x0a, 0x0e, 0x49, 0x73,
	...
	0x6d, 0x69, 0x6e, 0x32, 0xab, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a, 0x08,
	...
	0x65, 0x42, 0x1a, 0x5a, 0x18, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x76, 0x65, 0x2e, 0x61, 0x75,
	0x74, 0x68, 0x2e, 0x76, 0x31, 0x3b, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x76, 0x31, 0x62, 0x06, 0x70,
...
func file_sso_sso_proto_init() {
	...
	file_sso_sso_proto_msgTypes[2].OneofWrappers = []interface{}{
